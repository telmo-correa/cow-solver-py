"""Tests for Balancer stable pool math.

This module tests:
- BalancerStablePool dataclass
- calculate_invariant
- get_token_balance_given_invariant_and_all_other_balances
- stable_calc_out_given_in (sell order math)
- stable_calc_in_given_out (buy order math)
- filter_bpt_token (composable stable pools)
- Stable pool integration flows
- Rust test vectors
